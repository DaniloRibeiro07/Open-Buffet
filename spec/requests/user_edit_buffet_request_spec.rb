...
describe "Usuario faz uma requisicao de edição de um buffet" do
  ...
  it 'Faz um get sendo dono de outro buffet' do 
  ...
  it 'Faz um patch sendo dono de outro buffet' do 
    user = User.create!(name: "Carla", last_name: "Farias", email: 'carla@teste.com', password: 'teste123', company: true)
  ...
  it 'Faz um get sendo um cliente' do 
    user = User.create!(name: "Carla", last_name: "Farias", email: 'carla@teste.com', password: 'teste123', company: true)
  ...
  it 'Faz um get sendo um visitante' do 
    user = User.create!(name: "Carla", last_name: "Farias", email: 'carla@teste.com', password: 'teste123', company: true)
  ...
  it 'Faz um patch sendo um visitante' do 
    user = User.create!(name: "Carla", last_name: "Farias", email: 'carla@teste.com', password: 'teste123', company: true)
