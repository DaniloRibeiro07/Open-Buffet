...
describe 'Usuário clica em cancelar pedido' do
  context "Sendo um cliente" do
  ...
  context "Sendo o dono do buffet" do
    it 'Aguardando a avalição do buffet' do 
      user = User.create!(name: "Alecrim", last_name: "Farias", email: 'Alecrim@teste.com', password: 'teste123', company: true)
    ...
    it 'Aguardando a avalição do cliente' do 
      user = User.create!(name: "Alecrim", last_name: "Farias", email: 'Alecrim@teste.com', password: 'teste123', company: true)
