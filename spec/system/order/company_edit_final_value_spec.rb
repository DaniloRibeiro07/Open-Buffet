...
describe 'Dono do buffet acessa a pagína de visualização do buffet que espera a avaliação do client' do 
  it 'e edita o valor final com sucesso' do 
  ...
  it 'e edita o valor final com sucesso sem justificativa' do 
    user = User.create!(name: "Alecrim", last_name: "Farias", email: 'Alecrim@teste.com', password: 'teste123', company: true)
  ...
  it 'deixa campos obrigatórios vazios' do 
    user = User.create!(name: "Alecrim", last_name: "Farias", email: 'Alecrim@teste.com', password: 'teste123', company: true)
