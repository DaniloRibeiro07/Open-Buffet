...
describe 'Usuário clica em vê buffet' do 
  ...
  it "E vê os dados do buffet não sendo o dono do buffet com eventos cadastrados" do 
    other_user = User.create!(name: "Carla", last_name: "Farias", email: 'carla@teste.com', password: 'teste123', company: true)
  ...
  it "E vê os dados do buffet não sendo o dono do buffet sem eventos cadastrados" do 
    other_user = User.create!(name: "Carla", last_name: "Farias", email: 'carla@teste.com', password: 'teste123', company: true)
